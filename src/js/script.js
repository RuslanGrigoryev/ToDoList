...
//        - дело удаляется из левого списка и переносится с анимацией в правый и записывается в localStorageDone
// 4. Сделать справа список где будут храниться выполненные дела (перечеркнутые и  обязательно кнопка отмена)
//    При нажатии на кнопку отмена - дело возвращается назад в невыполненные